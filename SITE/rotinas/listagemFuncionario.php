		...
		<div class="listagem">
			<?php				
				...
				while ($contador < $linhas){
                    ...
                    echo "	<td>$email</td>";
                    echo "	<td>$obs</td>";
					echo "	<td><a href='excluirFuncionario.php?cod=$codFuncionario'>Excluir Dados</a></td>"; //php? a interrogacao indica que o metodo que ser? mandado ? o metodo get
					echo "	<td><a href='alterarFuncionario.php?cod=$codFuncionario'>Alterar Dados</a></td>";
					echo "</tr>";
